var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/talbot-lago-t150-css-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/talbot-lago-t150-css-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/talbot-lago-t150-css-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/talbot-lago-t150-css-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Talbot Lago T150 CSS?",
				description: "Get awesome Talbot Lago T150 CSS HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
