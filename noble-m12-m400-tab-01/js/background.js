var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/noble-m12-m400-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/noble-m12-m400-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/noble-m12-m400-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/noble-m12-m400-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Noble M12 M400?",
				description: "Get awesome Noble M12 M400 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
