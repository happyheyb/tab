var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/mg-mga-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/mg-mga-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/mg-mga-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/mg-mga-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like MG MGA?",
				description: "Get awesome MG MGA HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
