var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/jaguar-xkss-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/jaguar-xkss-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/jaguar-xkss-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/jaguar-xkss-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Jaguar XKSS?",
				description: "Get awesome Jaguar XKSS HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
