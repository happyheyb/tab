var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/lotus-espirit-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/lotus-espirit-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/lotus-espirit-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/lotus-espirit-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Lotus Espirit?",
				description: "Get awesome Lotus Espirit HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
