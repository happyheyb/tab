var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/porsche-carrera-2.7-rs-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/porsche-carrera-2.7-rs-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/porsche-carrera-2.7-rs-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/porsche-carrera-2.7-rs-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Porsche Carrera 2.7 RS?",
				description: "Get awesome Porsche Carrera 2.7 RS HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
