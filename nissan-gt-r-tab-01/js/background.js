var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/nissan-gt-r-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/nissan-gt-r-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/nissan-gt-r-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/nissan-gt-r-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Nissan GT R?",
				description: "Get awesome Nissan GT R HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
