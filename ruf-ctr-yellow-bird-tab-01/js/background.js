var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ruf-ctr-yellow-bird-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ruf-ctr-yellow-bird-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ruf-ctr-yellow-bird-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ruf-ctr-yellow-bird-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like RUF CTR YELLOW BIRD?",
				description: "Get awesome RUF CTR YELLOW BIRD HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
