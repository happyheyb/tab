var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/pagani-zonda-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/pagani-zonda-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/pagani-zonda-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/pagani-zonda-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Pagani Zonda?",
				description: "Get awesome Pagani Zonda HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
