var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/morgan-plus-4-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/morgan-plus-4-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/morgan-plus-4-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/morgan-plus-4-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Morgan Plus 4?",
				description: "Get awesome Morgan Plus 4 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
