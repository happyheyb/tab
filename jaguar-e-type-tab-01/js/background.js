var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/jaguar-e-type-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/jaguar-e-type-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/jaguar-e-type-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/jaguar-e-type-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Jaguar E Type?",
				description: "Get awesome Jaguar E Type HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
