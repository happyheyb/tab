var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/volvo-p1800-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/volvo-p1800-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/volvo-p1800-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/volvo-p1800-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Volvo P1800?",
				description: "Get awesome Volvo P1800 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
