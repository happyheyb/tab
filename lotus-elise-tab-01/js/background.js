var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/lotus-elise-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/lotus-elise-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/lotus-elise-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/lotus-elise-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Lotus Elise?",
				description: "Get awesome Lotus Elise HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
