var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/lincoln-continental-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/lincoln-continental-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/lincoln-continental-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/lincoln-continental-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Lincoln Continental?",
				description: "Get awesome Lincoln Continental HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
