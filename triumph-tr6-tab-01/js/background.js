var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/triumph-tr6-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/triumph-tr6-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/triumph-tr6-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/triumph-tr6-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Triumph TR6?",
				description: "Get awesome Triumph TR6 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
