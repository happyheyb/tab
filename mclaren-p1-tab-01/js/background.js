var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/mclaren-p1-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/mclaren-p1-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/mclaren-p1-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/mclaren-p1-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like McLaren P1?",
				description: "Get awesome McLaren P1 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
