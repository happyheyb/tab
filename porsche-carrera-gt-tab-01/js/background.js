var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/porsche-carrera-gt-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/porsche-carrera-gt-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/porsche-carrera-gt-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/porsche-carrera-gt-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Porsche Carrera GT?",
				description: "Get awesome Porsche Carrera GT HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
