var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/tesla-model-s-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/tesla-model-s-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/tesla-model-s-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/tesla-model-s-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Tesla Model S?",
				description: "Get awesome Tesla Model S HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
