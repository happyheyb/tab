var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/triumph-spitfire-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/triumph-spitfire-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/triumph-spitfire-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/triumph-spitfire-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Triumph Spitfire?",
				description: "Get awesome Triumph Spitfire HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
