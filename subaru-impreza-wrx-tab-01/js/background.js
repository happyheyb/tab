var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/subaru-impreza-wrx-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/subaru-impreza-wrx-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/subaru-impreza-wrx-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/subaru-impreza-wrx-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Subaru Impreza WRX?",
				description: "Get awesome Subaru Impreza WRX HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
