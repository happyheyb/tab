var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/lotus-elite-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/lotus-elite-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/lotus-elite-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/lotus-elite-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Lotus Elite?",
				description: "Get awesome Lotus Elite HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
