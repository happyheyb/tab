var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/pontiac-firebird-trans-am-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/pontiac-firebird-trans-am-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/pontiac-firebird-trans-am-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/pontiac-firebird-trans-am-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Pontiac Firebird Trans Am?",
				description: "Get awesome Pontiac Firebird Trans Am HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
