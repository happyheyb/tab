var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/mercury-coupe-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/mercury-coupe-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/mercury-coupe-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/mercury-coupe-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Mercury Coupe?",
				description: "Get awesome Mercury Coupe HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
