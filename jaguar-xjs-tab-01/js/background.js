var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/jaguar-xjs-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/jaguar-xjs-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/jaguar-xjs-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/jaguar-xjs-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Jaguar XJS?",
				description: "Get awesome Jaguar XJS HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
